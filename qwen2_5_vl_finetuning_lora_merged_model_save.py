...
# 2) LoRA 모델 로드
lora_model_path = "./model_weight/aihub_data_v1_1_crowdworks/qwen2_5_vl_3B_lora/llamafactory_4epoch"
...
# 모델 가중치 및 구성 저장
save_path = "./model_weight/aihub_data_v1_1_crowdworks/qwen2_5_vl_3B_lora/llamafactory_4epoch_merged"
